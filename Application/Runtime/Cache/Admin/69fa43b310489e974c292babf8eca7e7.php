     ...
     <section class="content">
		<div class="row">
            <div class="col-md-2 col-sm-6 col-xs-12">
              <div class="info-box">
                <span class="info-box-icon bg-teal-gradient"><i class="fa fa-home"></i></span>
                <div class="info-box-content">
                  <span class="info-box-text">开店审核</span>
                  <span class="info-box-number"><?php echo ($count["store"]); ?></span>
                </div>
              </div>
            </div>
            <div class="col-md-2 col-sm-6 col-xs-12">
              <div class="info-box">
                ...
                <div class="info-box-content">
                  <span class="info-box-text">类目申请</span>
                  <span class="info-box-number"><?php echo ($count["bind_class"]); ?></span>
                </div>
              </div>
            </div>
            <div class="col-md-2 col-sm-6 col-xs-12">
              <div class="info-box">
                ...
                <div class="info-box-content">
                  <span class="info-box-text">品牌申请</span>
                  <span class="info-box-number"><?php echo ($count["brand"]); ?></span>
                </div>
              </div>
            </div>
            <div class="col-md-2 col-sm-6 col-xs-12">
		...
		<div class="row">
          ...
          <div class="callout callout-success">
            <p> <b>TPshop</b>--( Thinkphp shop的简称 ) B2B2C 开源商城    包含(pc + wap + android + ios + 微商城)多终端 </p>
          </div>
     </section>
 </div>
 </body>
